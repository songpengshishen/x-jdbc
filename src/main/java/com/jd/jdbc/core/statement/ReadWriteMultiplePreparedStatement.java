package com.jd.jdbc.core.statement;

import java.sql.*;

/**
 * Created by wangsongpeng on 2018/1/18.
 */
public class ReadWriteMultiplePreparedStatement extends AbstractPreparedStatement {
    /**
